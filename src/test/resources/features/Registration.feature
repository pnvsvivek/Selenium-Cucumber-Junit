Feature: Vodacom PCTV check for Negative scenarios in Registration 
  ...
  Scenario Outline: Register with invalid user
    ...
    Examples: 
      ...
      | Test | 32829876487 | Test1234 |Invalid Username     |
      | Test | 2745672345  | Test1234 |Invalid Username     |

	@RegisterWithoutEnteringMandatoryFields @Regression
  Scenario Outline: Register without entering mandatory fields
	...
	@RegisterWithoutCheckingTandCcheckbox @Regression
  Scenario Outline: Register without checking the T&C checkbox
	...
	Examples: 
      | name | username    | password | 
      | Test | 27456723459 | Test1234 |
	  
	@RegisterWithNonMatchingPasswords @Regression
  Scenario Outline: Register with non matching passwords
    ...
    Examples: 
      ...
      | Test | 27234562345 | Test1234 | Testing		   |
	  
	@RegisterWithInvalidOTP @Regression
  Scenario Outline: Register with invalid OTP
    ...
    Examples: 
      ...
      | Test | 27829807581 | Test1234 | Testing		   | 1234 | OTP is invalid or has expired. Please try again. |