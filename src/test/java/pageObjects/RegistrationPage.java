...
public class RegistrationPage {
	...
	// @FindBy(xpath = "//input[@class='form-control ng-pristine ng-untouched
	// ng-empty ng-invalid ng-invalid-required']//self::input[@name='name']")
	...
	@FindBy(xpath = "//a[contains(@class,'btn btn-ctl btn-sign-in ng-binding')]//self::a[contains(text(),'Get Started')]")
	...
	@FindBy(xpath = "//div[contains(@class,'ng-modal-close')]")
	public List<WebElement> btn_Close_PopUp;
	...
	public void clickingOnRegistration(String name, String phoneNumber, String userPassword)
	...
	public void clickOnRegistration(String name, String phoneNumber, String userPassword, String... strings)
			throws InterruptedException, IOException {
	...
	public void submitOTP() {
		res.wait(driver).until(ExpectedConditions.elementToBeClickable(btn_submit_otp));
	...
	public void clickOnRegistration_passwordMismatch(String name, String phoneNumber, String userPassword,
